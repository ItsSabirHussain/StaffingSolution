      ...
      >
        ...
        <ul className={s.nav}>
          ...
          <LinksGroup
            ...
            activeItem={this.props.activeItem}
            header="Jobs Requests List "
            isHeader
            iconName="flaticon-list"
            link="/admin/jobsrequestslist"
            index="jobsrequestslist"
          />
          <LinksGroup
            onActiveSidebarItemChange={(activeItem) =>
              this.props.dispatch(changeActiveSidebarItem(activeItem))
            ...
            isHeader
            iconName="flaticon-list"
            link="/admin/companieslist"
            index="staffhiringrequests"
          />
          <LinksGroup
            onActiveSidebarItemChange={(activeItem) =>
              this.props.dispatch(changeActiveSidebarItem(activeItem))
