...
class StaffLogin extends React.Component {
  ...
  doLogin(e) {
    ...
    axios
      .post("http://localhost:4000/staff/stafflogin", {
        email: this.state.email,
        password: this.state.password,
      })
      .then((res) => {
        console.log("Here");
        localStorage.setItem("StaffID", res.data.token);
      ...
      <div className="auth-page">
        <Container>
          <Widget
            ...
            title={<h3 className="mt-0">Staff Login</h3>}
          >
            ...
            <form onSubmit={this.doLogin}>
              ...
              <div className="bg-widget auth-widget-footer">
                ...
                <Link className="d-block text-center mb-4" to="staffregister">
                  Create an Account
                </Link>
